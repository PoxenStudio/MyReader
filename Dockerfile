...
RUN pnpm --filter @poxenstudio/myreader setup-vendors
...
COPY --from=dependencies /app/app/node_modules /app/app/node_modules
COPY --from=dependencies /app/app/public/vendor /app/app/public/vendor
