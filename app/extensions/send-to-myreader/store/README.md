...
Generates the Chrome Web Store listing screenshots for the **Send to MyReader**
extension — the popup composited onto an on-brand background (matching
MyReader.com) with a headline.
...
- `send-to-myreader-1280x800.png`
- `send-to-myreader-640x400.png`
