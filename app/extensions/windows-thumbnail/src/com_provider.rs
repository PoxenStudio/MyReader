/// Windows COM Thumbnail Provider for MyReader
///
...
///
/// **Important**: Thumbnails are only shown when MyReader.exe is the default application
/// for the file type.
///
...
// ─────────────────────────────────────────────────────────────────────────────
// CLSID for MyReader Thumbnail Provider
// ─────────────────────────────────────────────────────────────────────────────

/// CLSID: {A1B2C3D4-E5F6-7890-ABCD-EF1234567890}
pub const CLSID_MYBOOKS_THUMBNAIL: GUID = GUID::from_u128(0xA1B2C3D4_E5F6_7890_ABCD_EF1234567890);
...
/// Check if MyReader.exe is the default application for a given file extension.
...
/// Check if MyReader is the default app for a specific file path.
...
pub unsafe extern "system" fn DllGetClassObject(
    ...
    *ppv = std::ptr::null_mut();
    ...
    if *rclsid != CLSID_MYBOOKS_THUMBNAIL {
...
fn clsid_string() -> String {
    format!(
        ...
        CLSID_MYBOOKS_THUMBNAIL.data1,
        CLSID_MYBOOKS_THUMBNAIL.data2,
        CLSID_MYBOOKS_THUMBNAIL.data3,
        CLSID_MYBOOKS_THUMBNAIL.data4[0],
        CLSID_MYBOOKS_THUMBNAIL.data4[1],
        CLSID_MYBOOKS_THUMBNAIL.data4[2],
        CLSID_MYBOOKS_THUMBNAIL.data4[3],
        CLSID_MYBOOKS_THUMBNAIL.data4[4],
        CLSID_MYBOOKS_THUMBNAIL.data4[5],
        CLSID_MYBOOKS_THUMBNAIL.data4[6],
        CLSID_MYBOOKS_THUMBNAIL.data4[7]
    )
}
...
unsafe fn register_server_impl() -> Result<(), HRESULT> {
    ...
    set_reg_value(clsid_key, "", "MyReader Thumbnail Provider")?;
