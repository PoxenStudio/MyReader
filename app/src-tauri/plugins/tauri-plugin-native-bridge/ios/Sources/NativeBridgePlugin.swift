...
class NativeBridgePlugin: Plugin {
  ...
  @objc public override func load(webview: WKWebView) {
    ...
    // covers MyReader's annotation toolbar. See ContextMenuSuppressor.
  ...
  /// Bridge between the MyReader Share Extension (separate process) and
  /// the host app's JS, via the App Group container at
  /// `group.com.poxenstudio.mybooks`. Two directions on every activation:
  ///
  ...
  private static let syncKeychainService = "com.poxenstudio.mybooks.sync-passphrase"
