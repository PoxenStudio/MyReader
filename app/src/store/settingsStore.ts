...
interface SettingsState {
   ...
   * panel renders nested sub-pages (e.g. Integrations → WebDAV / OPDS), this
   * string tells the panel which one to drill into. Cleared by the panel
   * after consumption. Format is panel-specific — Integrations recognises
   * 'webdav' | 'opds'.
   */
