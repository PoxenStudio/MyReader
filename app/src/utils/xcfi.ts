 ...
 * Converts between MyReader (foliate-js) CFI format and KOReader CREngine XPointer format
 */
...
export class XCFI {
  ...
  /**
   * Check if an element is injected by MyReader at runtime and should be
