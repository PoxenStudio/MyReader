...
/**
 * Inline version of /images/connection.svg. The original asset hardcodes a
 * black fill (#0F0F0F), which disappears on the dark circular buttons used
 * for the NAS remote-login affordance — this variant uses `currentColor` so
 * callers can set `text-*` (and optionally wrap it in a colored circle) to
 * keep it visible in both themes.
 */
const NasConnectionIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export default NasConnectionIcon;
