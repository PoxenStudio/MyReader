...
// getBookHash only strips a trailing "-<7-char-uniqueId>" suffix; 'abc123' is
// 6 chars, so 'test-book-abc123' passes through unchanged as the bookId.
const POSITION_KEY = 'readest_rsvp_pos_test-book-abc123';
