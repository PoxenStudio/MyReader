...
export interface ImportFromFolderResult {
   ...
   * notes) still live in MyReader's data dir, so deleting the local
   * copy of a book on MyReader's side will physically remove the
   * source file under the registered folder. Defaults to `false`,
   * which keeps the legacy "copy into MyReader" behaviour and leaves
