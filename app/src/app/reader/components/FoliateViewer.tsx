...
import { getBookDirFromLanguage, getBookDirFromWritingMode, getBookHash } from '@/utils/book';
...
const FoliateViewer: React.FC<{
  ...
  useEffect(() => {
    ...
    const openBook = async () => {
      ...
      const thisId = getBookHash(bookKey);
      ...
      // WebDAV sync) skip until the user takes a reading action. The
