...
/**
 * Layout convention for the WebDAV "MyReader" subtree under the user's
...
export const WEBDAV_BASE_DIR = 'MyReader';
...
/** Absolute path of the MyReader base directory (where library.json lives). */
