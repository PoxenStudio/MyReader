 ...
 *   <rootPath>/MyReader/books/<hash>/config.json
 *
...
/**
 * Pull `<rootPath>/MyReader/books/<hash>/config.json`, merge into the
 ...
 *   <rootPath>/MyReader/books/<hash>/<safe-title>.<ext>
 *
 ...
 *   <rootPath>/MyReader/books/<hash>/cover.png
 *
...
/**
 * Delete the per-book directory `<rootPath>/MyReader/books/<hash>/`
 ...
 *      anything yet).
 *   2. `pushBookConfig` — creates `MyReader/books/<hash>/config.json`.
