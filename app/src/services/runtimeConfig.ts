export interface MyBooksRuntimeConfig {
  supabaseUrl?: string;
...
declare global {
  interface Window {
    __MYBOOKS_RUNTIME_CONFIG?: MyBooksRuntimeConfig;
  }
}

export const getRuntimeConfig = () =>
  typeof window === 'undefined' ? undefined : window.__MYBOOKS_RUNTIME_CONFIG;

export const getServerRuntimeConfig = (): MyBooksRuntimeConfig => ({
