 ...
 * background all match MyReader's current theme + UI language.
 *
...
export function getClipOptions(_: Translate): ClipOptions {
  ...
  return {
    windowTitle: _('Saving to your MyReader library…'),
    overlayTitle: _('Saving to MyReader'),
    loadingStatus: _('Loading article…'),
    capturingStatus: _('Capturing article…'),
    savedTitle: _('Saved to MyReader'),
    background: bg,
    foreground: fg,
  };
}
