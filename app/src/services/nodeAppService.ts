...
export class NodeAppService extends BaseAppService {
  // Cloned per instance: `nodeFileSystem` is a shared module-level singleton,
  // and a custom-root instance must not mutate the resolver every other
  // instance (including ones without a customRootDir) sees.
