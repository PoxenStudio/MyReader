...
import { MYBOOKS_NODE_BASE_URL, MYBOOKS_WEB_BASE_URL } from './constants';
import { getRuntimeConfig } from './runtimeConfig';

declare global {
  interface Window {
    __MYBOOKS_CLI_ACCESS?: boolean;
  }
}
...
export const getNodeBaseUrl = () =>
  process.env['NEXT_PUBLIC_NODE_BASE_URL'] ?? MYBOOKS_NODE_BASE_URL;
